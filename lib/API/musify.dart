...
Future<List> fetchSongsList(String searchQuery) async {
  try {
    ...
    // Add "topic" to search to prioritize audio-only versions (Auto-generated by YouTube)
    final searchQueryWithTopic = '$searchQuery topic';
    final List<Video> searchResults = await _yt.search.search(searchQueryWithTopic);

    // Sort results to prioritize Topic songs (audio-only, auto-generated by YouTube)
    final sortedResults = List<Video>.from(searchResults)
      ..sort((a, b) {
        final aIsTopic = isTopicChannel(a.author);
        final bIsTopic = isTopicChannel(b.author);
