...
/// Check if a channel/author name indicates a "Topic" channel
/// (Auto-generated by YouTube with audio-only content)
bool isTopicChannel(String author) {
  final lowerAuthor = author.toLowerCase();
  return lowerAuthor.contains('- topic') || lowerAuthor.endsWith(' topic');
}
...
Map<String, dynamic> returnSongLayout(
  ...
  'isLive': song.isLive,
  'isTopic': isTopicChannel(song.author),
};
